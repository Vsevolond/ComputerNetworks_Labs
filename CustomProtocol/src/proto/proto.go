...
func Substring(str string, substr string) (positions []string) {
	zf := Zfunc(substr + "#" + str)
	n := len(str)
	m := len(substr)
...
// add - добавить/изменить строку
// string =
// search - искать подстроку
// substring =
